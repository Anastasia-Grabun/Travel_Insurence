...
import org.example.travel.insurance.core.underwriting.calculators.medical.TravelMedicalRiskPremiumCalculator;
...
class TravelMedicalRiskPremiumCalculatorTest {
    ...
    void shouldCalculatePremiumCorrectly() {
        ...
        when(dateTimeUtil.calculateDurationInDays(request.getAgreementDateFrom(), request.getAgreementDateTo())).thenReturn(daysCount.longValue());
