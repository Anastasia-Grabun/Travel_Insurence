...
class TravelCalculatePremiumRequestValidator {
    ...
    public List<ValidationError> validate(TravelCalculatePremiumRequest request) {
        ...
        validateAgreementDateToAfterAgreementDateFrom(request).ifPresent(errors::add);
    ...
    private Optional<ValidationError> validateAgreementDateToAfterAgreementDateFrom(TravelCalculatePremiumRequest request){
